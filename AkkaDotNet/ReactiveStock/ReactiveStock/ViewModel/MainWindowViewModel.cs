...
namespace ReactiveStock.ViewModel
{
    ...
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        {
            _chartingActorRef = ActorSystemReference.ActorSystem.ActorOf(Props.Create(() => new LineChartingActor(PlotModel)));

            _stocksCoordinatorActorRef = ActorSystemReference.ActorSystem.ActorOf
                (Props.Create(() => new StockCoordinatorActor(_chartingActorRef)), "StockCoordinator");
        }
